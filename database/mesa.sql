...
--
-- Servidor: localhost
-- Tiempo de generación: 17-02-2019 a las 04:03:33
...
CREATE TABLE IF NOT EXISTS `telefono` (
  ...
  `Versiones` text COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`id`)
